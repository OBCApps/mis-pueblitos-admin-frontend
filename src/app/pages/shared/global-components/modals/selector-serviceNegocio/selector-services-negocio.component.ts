...
export class SelectorServicesNegocioComponent {
  ...
  search_all() {
    ...
    this.modalService.list_by_filter(this.filtro)
      .subscribe(pg => {
  ...
  option_pagination(value: any) {
    ...
    if (value == 'next') {
      if (this.filtro.paginacion.paginacionRegistroInicio + this.filtro.paginacion.paginacionRegistrosPorPagina < total) {
        this.filtro.paginacion.paginacionRegistroInicio = this.filtro.paginacion.paginacionRegistroInicio + this.filtro.paginacion.paginacionRegistrosPorPagina;
        this.search_all();
      }
    } else if (value == 'prev') {
      if (this.filtro.paginacion.paginacionRegistroInicio - this.filtro.paginacion.paginacionRegistrosPorPagina >= 0) {
        this.filtro.paginacion.paginacionRegistroInicio = this.filtro.paginacion.paginacionRegistroInicio - this.filtro.paginacion.paginacionRegistrosPorPagina;
        this.search_all();
      }
    }
