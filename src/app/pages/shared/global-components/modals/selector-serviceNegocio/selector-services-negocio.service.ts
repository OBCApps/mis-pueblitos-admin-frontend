...
import { API_SERVICE_COMUN } from "../../../../../../environments/environment.prod";
@Injectable({
...
export class SelectorServicesNegocio {
    ...
    public list_by_filter(dto: any): Observable<any> {
        return this.http.post<any>(this.API_SERVER_COMUN_DEPARTAMENTO + '/listarServiciosFiltro', dto).pipe(
