...
export class HabitacionService {
  ...
  get_info_adicional_by_id(id: any): Observable<any> {
    return this.http
      .get<any>(this.SERVER_HABITACION + '/infoAdicional/' + id)
      .pipe(
        map((response) => {
          return response;
        })
  ...
  create(data: DtoHabitacion): Observable<any> {
    return this.http
      .post<DtoHabitacion>(this.SERVER_HABITACION + '/register', data)
      .pipe(
        map((response) => {
          return response;
        })
  ...
  uploadFoto(id: string, data: any): Observable<any> {
    return this.http
      .post<any>(this.SERVER_HABITACION + '/upload-foto/' + id, data)
      .pipe(
        map((response) => {
          return response;
        })
  ...
  update(data: DtoHabitacion): Observable<any> {
    return this.http
      .patch<DtoHabitacion>(this.SERVER_HABITACION + '/update/' + data.id, data)
      .pipe(
        map((response) => {
          return response;
        })
  ...
  delete(data: DtoHabitacion): Observable<any> {
    return this.http
      .delete<DtoHabitacion>(this.SERVER_HABITACION + '/delete/' + data.id)
      .pipe(
        map((response) => {
          return response;
        })
